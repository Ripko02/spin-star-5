...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-09042e9c');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-09042e9c');}
...
var brandEl=document.querySelector('.rl-brand-09042e9c');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
